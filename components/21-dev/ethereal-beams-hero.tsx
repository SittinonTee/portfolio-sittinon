...
>(({ material, width, count, height }, ref) => {
  const mesh = useRef<THREE.Mesh<THREE.BufferGeometry, THREE.ShaderMaterial>>(
    null as unknown as THREE.Mesh<THREE.BufferGeometry, THREE.ShaderMaterial>,
  );
...
const DirLight: FC<{ position: [number, number, number]; color: string }> = ({
  ...
  const dir = useRef<THREE.DirectionalLight>(
    null as unknown as THREE.DirectionalLight,
  );
